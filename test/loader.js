...
var compiler = require('../node-nim-compiler');

var loader = require('../index.js');

var fixturesDir = path.join(__dirname, 'fixtures');
var badSource = path.join(fixturesDir, 'Bad.nim');
var goodSource = path.join(fixturesDir, 'Good.nim');
var goodDependency = path.join(fixturesDir, 'GoodDependency.nim');
